...
public class SelectionSortTest {
    ...
    static void testSelectionSort(String caseName, int[] original) {
    ...
    public static void main(String[] args) {
        ...
        for (int n : sizes) {
            ...
            testSelectionSort("Random", random);
            testSelectionSort("Ascending", ascending);
            testSelectionSort("Descending", descending);
            testSelectionSort("Partially Sorted", partial);
            testSelectionSort("Mostly Sorted", mostly);
            testSelectionSort("Duplicates", duplicate);
        }
    }
}