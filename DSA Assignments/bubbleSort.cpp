...
void testBubbleSort(string caseName, int original[], int n)
{
    int *arr = new int[n];
...
int main()
{
    ...
    for(int s = 0; s < 4; s++)
    {
        ...
        testBubbleSort("Random", random, n);
        testBubbleSort("Ascending", ascending, n);
        testBubbleSort("Descending", descending, n);
        testBubbleSort("Partially Sorted", partial, n);
        testBubbleSort("Mostly Sorted", mostly, n);
        testBubbleSort("Duplicates", duplicate, n);
